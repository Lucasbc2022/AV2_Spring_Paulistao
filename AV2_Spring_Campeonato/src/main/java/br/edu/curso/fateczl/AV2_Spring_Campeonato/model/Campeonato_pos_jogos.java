...
public class Campeonato_pos_jogos {
	...
	public String toString() {
		return "Campeonato_pos_jogos [nome_time=" + nome_time + ", num_jogos_disputados=" + num_jogos_disputados
				...
				+ pontos + ", classificacao=" + classificacao + "]";
	}
